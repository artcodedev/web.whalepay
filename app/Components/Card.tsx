...
const Card = ({...pr}: Props) => {
    ...
    const formatNumber = (num: string): string => {
        ...
        const onlyNumbers = num.replace(/[^\w]/g, '')

        return onlyNumbers.replace(regex, (regex, a, b, c, d) =>
    ...
    return (
        <>
            ...
            <div className={style['Card']}>
                <svg version="1.1" fill="#ccc
                         " id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" xmlSpace="preserve">
                    <g id="Front">
                        ...
                        <g id="cchip">
                            <g>
                                <path className={style['Card__st2']} d="M168.1,143.6H82.9c-10.2,0-18.5-8.3-18.5-18.5V74.9c0-10.2,8.3-18.5,18.5-18.5h85.3
                        c10.2,0,18.5,8.3,18.5,18.5v50.2C186.6,135.3,178.3,143.6,168.1,143.6z"></path>
                            </g>
                            <g fill="#000">
                                <g>
                                    <rect x="82" y="70" className="st12" width="1.5" height="60"></rect>
                                </g>
                                <g>
                                    <rect x="167.4" y="70" className="st12" width="1.5" height="60"></rect>
                                </g>
                                <g>
                            ...
                            c3.1-3.2,4.8-7.4,4.8-11.8C142.4,78.4,134.8,70.8,125.5,70.8z"></path>
                                ...
                                <g>
                                    <rect x="82.8" y="82.1" className="st12" width="25.8" height="1.5"></rect>
                                </g>
                                <g>
                                    <rect x="82.8" y="117.9" className="st12" width="26.1" height="1.5"></rect>
                                </g>
                                <g>
                                    <rect x="142.4" y="82.1" className="st12" width="25.8" height="1.5"></rect>
                                </g>
                                <g>
                                    <rect x="142" y="117.9" className="st12" width="26.2" height="1.5"></rect>
                                </g>
                            </g>
                        </g>
                    </g>
